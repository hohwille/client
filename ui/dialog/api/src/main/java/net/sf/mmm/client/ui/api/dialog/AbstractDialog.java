...
/**
 * This is the abstract base interface for a dialog or screen of the client application. This should NOT be mixed with a
 * popup.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public abstract interface AbstractDialog
    extends AttributeReadId<String>, AttributeReadTitle<String>, AttributeReadVisible {
