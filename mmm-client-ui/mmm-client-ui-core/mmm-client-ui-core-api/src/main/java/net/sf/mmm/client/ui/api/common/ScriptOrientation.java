...
public enum ScriptOrientation {
   ...
   * vice versa.
   * 
   * @return <code>true</code> if horizontal ordering is left-to-right, <code>false</code> for right-to-left.
   */
  public abstract boolean isLeftToRight();

  /**
   * This method determines if the primary ordering of script and layout goes horizontally. Vertical ordering
   * always goes from the top to the bottom.
   * 
   * @return <code>true</code> if the primary ordering is horizontal, <code>false</code> for vertical.
   */
